                ...
                Row(
                    ...
                    Surface(
                        ...
                        TextField(
                            ...
                            Text(
                                "Enter Barcode", color = Color.Gray, fontSize = 14.sp
                            )
                        ...
                        ), shape = RoundedCornerShape(26.dp), modifier = Modifier.weight(1f)
                        )
                    }
                    Spacer(modifier = Modifier.width(8.dp))
                    Surface(
                        shadowElevation = 2.dp, shape = CircleShape, modifier = Modifier.size(46.dp)
                    ) {
                        Box(
        ...
        Column(
            ...
            Card(
                ...
                Column(modifier = Modifier.padding(16.dp)) {
                    ...
                    Text(
                        randomFact, fontSize = 14.sp, color = Color(0xFF757575), lineHeight = 20.sp
                    )
                }
            }
